...
public class BBCNewsImpl implements BBCNews {
    @Override
    public List<com.slownews.model.BBCNews> getNews() throws IOException {
        ...
        List<com.slownews.model.BBCNews> news = new LinkedList<>();
        ...
        for (int i = 0; i < titles.size(); i++) {
            ...
            com.slownews.model.BBCNews newsItem = new com.slownews.model.BBCNews(title, description, link);
            news.add(newsItem);
