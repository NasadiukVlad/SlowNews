...
import com.slownews.model.JavaWorldNewsXPathMap;
...
public class JavaWorldNewsImpl implements JavaWorldNews {
    ...
    @Override
    public List<com.slownews.model.JavaWorldNews> getJavaWorldNews() throws IOException {
        ...
        List<com.slownews.model.JavaWorldNews> javaWorldNews = new LinkedList<>();
        ...
        for (int i = 0; i < titles.size(); i++) {
            ...
            com.slownews.model.JavaWorldNews newsItem = new com.slownews.model.JavaWorldNews(title, sb.toString(), link);
