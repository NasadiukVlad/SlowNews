...
import com.slownews.model.HabrahabrXpathMap;
...
public class HabrahabrNewsImpl implements HabrahabrNews {
    ...
    @Override
    public List<com.slownews.model.HabrahabrNews> getHabrahabrNews() throws IOException {
        ...
        List<com.slownews.model.HabrahabrNews> habrahabrNews = new LinkedList<>();
        ...
        for (int i = 0; i < titles.size(); i++) {
            ...
            com.slownews.model.HabrahabrNews newsItem = new com.slownews.model.HabrahabrNews(title, sb.toString(), link);
